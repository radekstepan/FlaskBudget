...
class LoansTestCases(unittest.TestCase):
    ...
    def test_edit_give_loan_from_private_to_normal_user(self):
        # add normal user
        self.app.get('/test/create-user/Barunka')
        ...
        # add private user
        rv = self.app.post('/user/add-private', data=dict(name="Jára"), follow_redirects=True)
        assert 'Private user added' in rv.data
        ...
        # give loan
        rv = self.app.post('/loan/give', data=dict(user=3, date="2011-02-06", deduct_from=3,
                                                   description="I give you money", amount=11.10), follow_redirects=True)
        assert 'Loan given' in rv.data
        ...
        # edit loan post
        rv = self.app.post('/loans/edit/1', data=dict(user=2, date="2011-02-06", deduct_from=4,
                                                      description="I rather give you money", amount=6.89),
                           follow_redirects=True)
        assert 'Loan edited' in rv.data
        ...
        assert '''
            ...
            <div class="date">to <a href="/loans/with/barunka">Barunka</a>
                2011-02-06</div>
        ''' in rv.data
        assert '<div class="date">to <a href="/loans/with/jara">Jára</a>' not in rv.data
    ...
    def test_edit_get_loan_from_private_to_normal_user(self):
        # add normal user
        self.app.get('/test/create-user/Barunka')
        ...
        # give loan
        rv = self.app.post('/loan/get', data=dict(user=3, date="2011-02-06", credit_to=3,
                                                   description="You give me money", amount=11.10), follow_redirects=True)
        assert 'Loan received' in rv.data
        ...
        # edit loan post
        rv = self.app.post('/loans/edit/1', data=dict(user=2, date="2011-02-06", credit_to=4,
                                                      description="You rather give me money", amount=6.89),
                           follow_redirects=True)
        assert 'Loan edited' in rv.data
        ...
        assert '''
            ...
            <div class="date">from <a href="/loans/with/barunka">Barunka</a>
                2011-02-06</div>
        ''' in rv.data
        assert '<div class="date">from <a href="/loans/with/jara">Jára</a>' not in rv.data
